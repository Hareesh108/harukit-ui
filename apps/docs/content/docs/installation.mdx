...
1. Check the [troubleshooting section](/docs/troubleshooting) for common solutions
2. Visit our [GitHub repository](https://github.com/your-username/harukit) for issues and discussions
3. Join our [Discord community](https://discord.gg/harukit) for real-time support

## Next Steps

After successful installation:

1. **Add components**: Use `npx harukit@latest add <component-name>` to add the components you need
2. **Customize styling**: Modify the CSS variables in your global CSS file
3. **Explore components**: Check out the [components documentation](/docs/components) for usage examples
4. **Configure your project**: Adjust the `harukit.json` configuration file as needed
