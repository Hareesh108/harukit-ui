...
bunx --bun harukit@latest add accordion button card input label tooltip
```
...
# Add all available components
pnpm dlx harukit@latest add accordion button card input label tooltip
```
...
# Add multiple components
yarn harukit@latest add button card input

# Add all available components
yarn harukit@latest add accordion button card input label tooltip
```
